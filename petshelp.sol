...
library Address {
    ...
    function isContract(address account) internal view returns (bool) {
        ...
        bytes32 codehash;
        bytes32 accountHash = 0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a450;
...
contract PETSHELPCOIN is Context, IERC20, Ownable {
    ...
    string private _name = 'PetsHelp Coin';
